...
public class Adaptador {
	...
	// Susituye el DataOutputStream por randomAccessFile
	// permite que grabar clientes se haga insertandolo al final
	...
	public boolean grabar(String path, Cliente objeto) {
		...
		try {
			...
			//una vez hecho extrae el adecuador de cliente
